...
function App() {
  ...
  {/* Card */}
  <div className="bg-white/80 backdrop-blur-xl border border-yellow-300/40 shadow-[0_8px_25px_rgba(0,0,0,0.07)] rounded-3xl p-10 max-w-2xl text-center">
    ...
    <p className="text-gray-700 mt-4 text-lg leading-relaxed">
      Your gateway to internships, industrial training, and placement opportunities.
      Discover the right path to build your future career.
    </p>
